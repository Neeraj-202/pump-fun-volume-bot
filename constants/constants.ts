...
export const USE_WALLET_LIST = retrieveEnvVariable('USE_WALLET_LIST', logger) === 'true';
export const WALLET_LIST_REFRESH_INTERVAL = Number(retrieveEnvVariable('WALLET_LIST_REFRESH_INTERVAL', logger));
